// =====================================================================
// api.js - OldChat For Kivotos Next 协议层（纯前端 / 零构建）
// 从 app.js 拆分而来：
//   块A 端点与媒体URL（225-296, 318-345）
//   块B 认证 fetch 包装 v1<->v2 / ECDH 握手 / AES-CBC（1899-2472）
//   块C 加密辅助 const Crypto（2473-2519）
// 不引用任何 DOM；运行期依赖由 app.js 注入的
//   window.__tauriHttpFetchImpl / window.__httpSession。
// 必须在 app.js 之前加载（见 index.html）。
// =====================================================================
